...
# This class represents the ball (pellets)
...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height):
        ...
        # Use soupbowl.png for pellets/power-ups
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y, filename):
        ...
        # Set height, width - use weasel.png for player
...
class Ghost(Player):
    # Constructor function - use soupcan_new for ghosts (with translucency)
    def __init__(self,x,y, filename):
        # Call the parent's constructor
        pygame.sprite.Sprite.__init__(self)
        ...
        # Use soupcan_new.png for ghosts (with translucency)
