...
def main():
    ...
    # Replace the top area (Pay Dirt/Best Robotics text) with solid blue sky
    SKY_BLUE = (57, 57, 255)  # Match the original sky blue color
    pygame.draw.rect(background, SKY_BLUE, (0, 0, background.get_width(), 200))
